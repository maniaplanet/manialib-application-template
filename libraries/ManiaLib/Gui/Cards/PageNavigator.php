...
{
	/**
	 * @var ManiaLib_Gui_Elements_Icons64x64_1
	 */
	public $arrowNext;
	/**
	 * @var ManiaLib_Gui_Elements_Icons64x64_1
	...
	public $arrowNoneStyle = ManiaLib_Gui_Elements_Icons64x64_1::StarGold;
	public $arrowNextStyle = ManiaLib_Gui_Elements_Icons64x64_1::ArrowNext;
	public $arrowPrevStyle = ManiaLib_Gui_Elements_Icons64x64_1::ArrowPrev;
	public $arrowFastNextStyle = ManiaLib_Gui_Elements_Icons64x64_1::ArrowFastNext;
	public $arrowFastPrevStyle = ManiaLib_Gui_Elements_Icons64x64_1::ArrowFastPrev;
	public $arrowFirstStyle = ManiaLib_Gui_Elements_Icons64x64_1::ArrowFirst;
	public $arrowLastStyle = ManiaLib_Gui_Elements_Icons64x64_1::ArrowLast;
	...
	{
		$this->arrowNext = new ManiaLib_Gui_Elements_Icons64x64_1($iconSize);
		$this->arrowPrev = new ManiaLib_Gui_Elements_Icons64x64_1($iconSize);
		$this->arrowFastNext = new ManiaLib_Gui_Elements_Icons64x64_1($iconSize);
		$this->arrowFastPrev = new ManiaLib_Gui_Elements_Icons64x64_1($iconSize);
		$this->arrowLast = new ManiaLib_Gui_Elements_Icons64x64_1($iconSize);
		$this->arrowFirst = new ManiaLib_Gui_Elements_Icons64x64_1($iconSize);
		$this->text = new ManiaLib_Gui_Elements_Label(5);
	...
	function save()
	{
		...
		// Save the gui
		ManiaLib_Gui_Manialink::beginFrame($this->posX, $this->posY, $this->posZ);
		{
			if ($this->showText)
			{
				$this->text->save();
